...
Then, select *Integrations* and click the *New Integration* button.
...
+
You will be redirected to *Integrations* for your service. An Integration Key is generated on this screen.
+
[role="screenshot"]
