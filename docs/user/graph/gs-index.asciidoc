...
image::images/graph-vertices-connections.jpg[Image demonstrating the "vertices", "terms", and "connections" features of the graph. "Vertices" are green circles, labelled with "terms" captions, and are linked with grey "connections" lines]
