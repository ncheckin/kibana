...
To view advanced node metrics, click **Advanced** for a node. *Advanced* shows additional metrics, such as memory and garbage collection
...
To view advanced index metrics, click **Advanced** for an index. *Advanced* shows additional metrics, such as memory statistics reported
