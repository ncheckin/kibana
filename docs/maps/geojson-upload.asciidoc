...
+
[role="screenshot"]
image::maps/images/fu_gs_select_source_file_upload.png[Image showing the "upload GeoJSON" option to select. The correct option is the first of three, and is at the top]
