...
+
[role="screenshot"]
image::maps/images/fu_gs_new_england_map.png[Map of New England area, with "add layer" button in top right corner of the screen selected blue]
...
+
[role="screenshot"]
image::maps/images/fu_gs_flight_paths.png[Image showing updated map, with menu listing layers in the top right corner of the screen]
...
+
[role="screenshot"]
image::maps/images/fu_gs_lightning_intensity.png[Image displaying the lightning heat map layer, which is green in the area of higher frequency lightning strikes, and blue in lower frequency areas.]
...
[role="screenshot"]
image::maps/images/fu_gs_final_map.png[Image displaying final map, with all layers except "lighting strikes" selected.]
