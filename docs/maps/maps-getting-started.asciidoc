...
[role="screenshot"]
image::maps/images/sample_data_web_logs.png[Example of Maps' read only access indicator in Kibana's header. Out of the 4 layers show, 3 are selected]
...
+
[role="screenshot"]
image::maps/images/gs_add_cloropeth_layer.png[Image of map with darkened countries that fit the filter criteria]
...
+
[role="screenshot"]
image::maps/images/gs_add_es_document_layer.png[Image of updated map]
...
+
[role="screenshot"]
image::maps/images/sample_data_web_logs.png[Image showing version of the map with the customized filters appearing at the specified zoom]
...
+
[role="screenshot"]
image::maps/images/gs_dashboard_with_map.png[Image showing updated dashboard, displaying the map you have just created along with other previously added graphs.]
...
+
[role="screenshot"]
image::maps/images/gs_dashboard_with_terms_filter.png[Finalized dashboard, adjusted to the new filters]
