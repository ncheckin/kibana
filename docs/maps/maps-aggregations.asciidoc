...
[role="screenshot"]
image::maps/images/grid_to_docs.gif[Gif detailing how the "grid aggregation" and "documents" layers are only visible when the map is zoomed in]
...
[role="screenshot"]
image::maps/images/top_hits.png[Image displaying the most relevant documents on the map]
...
image::maps/images/point_to_point.png[Image displaying the point-to-point connection on the map, with an array of different line colors and thicknesses.]
...
[role="screenshot"]
image::maps/images/gs_add_cloropeth_layer.png[Image displaying filtered map, with coubtries with the most web traffic colored the darkest.]
...
[role="screenshot"]
image::maps/images/terms_join_shared_key_config.png[Image showing example of what entering shared key information looks like]
...
[role="screenshot"]
image::maps/images/terms_join_metric_config.png[Image showing options for "metrics configuration" field. The options shown are document count and field "bye" average for all documents.]
