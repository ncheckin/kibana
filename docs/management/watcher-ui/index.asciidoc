...
*Execution history* shows each time the watch is triggered and the
...
*Action statuses* lists all actions associated with the watch and
...
*Simulate* allows you to override parts of the watch, and then run a
